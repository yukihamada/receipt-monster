    ...
    <main className="flex-grow py-12 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto p-4">
        ...
        <ul className="list-disc list-inside mb-4">
          <li>Discord: <a href="https://discord.gg/yourdiscordlink" className="text-blue-500 hover:underline">レシートモンスター公式Discord</a></li>
          <li>X (旧Twitter): <a href="https://twitter.com/yourtwitterhandle" className="text-blue-500 hover:underline">@receiptmonster</a></li>
          <li>GitHub: <a href="https://github.com/yourgithubrepo" className="text-blue-500 hover:underline">レシートモンスターGitHubリポジトリ</a></li>
        </ul>
