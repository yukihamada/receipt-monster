      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <select className="w-full border rounded p-2 mb-4 text-gray-700 bg-white">
              <option>無料プラン</option>
              <option>ベーシックプラン</option>
              <option>プロフェッショナルプラン</option>
            </select>
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <p className="text-gray-700 mb-4">現在の支払い方法: クレジットカード（**** **** **** 1234）</p>
            <div className="text-center">
